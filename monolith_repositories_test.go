...
var mrUpdateJSONResponse = `
{
  ...
  "azure_kwargs": {
    ...
    "container": "fomo",
    "prefix": "haha",
    "client_id": "bb887757-7e98-4dfd-b323-e7ceb6ea96b3",
    "tenant_id": "a00857c2-99ac-4e9d-8a44-199b43a49cac",
    "client_secret": "9db62963b3daec651edee4215ccede35"
  },
  "created_at": "2022-07-22T01:02:03.444444",
  "updated_at": "2022-07-22T01:02:03.444444"
}
...
func TestMonolithRepositoriesService_Update(t *testing.T) {
	...
	want := &MonolithRepository{
		...
		Name:               "Default",
		Backend:            "S3",
		Azure: &MonolithAzureBackend{
			StorageAccount: "yolo",
			Container:      "fomo",
			Prefix:         "haha",
			ClientID:       "bb887757-7e98-4dfd-b323-e7ceb6ea96b3",
			TenantID:       "a00857c2-99ac-4e9d-8a44-199b43a49cac",
			ClientSecret:   "9db62963b3daec651edee4215ccede35",
		},
		Created: Timestamp{referenceTime},
		Updated: Timestamp{referenceTime},
	}
